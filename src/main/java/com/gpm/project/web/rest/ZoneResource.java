...
/**
 * REST controller for managing {@link com.gpm.project.domain.Zone}.
 */
@RestController
@RequestMapping("/api")
public class ZoneResource {
    ...
    private static final String ENTITY_NAME = "projectServiceZone";
    ...
    public ResponseEntity<List<ZoneDTO>> getAllZones(
        ...
        Page<ZoneDTO> page;
        if (eagerload) {
            page = zoneService.findAllWithEagerRelationships(pageable);
        } else {
            page = zoneService.findAll(pageable);
        }
