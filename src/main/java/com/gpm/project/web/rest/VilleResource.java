...
import com.gpm.project.service.VilleService;
...
/**
 * REST controller for managing {@link com.gpm.project.domain.Ville}.
 */
@RestController
@RequestMapping("/api")
public class VilleResource {
    ...
    private static final String ENTITY_NAME = "projectServiceVille";
     ...
     */
    @GetMapping("/villes")
    public ResponseEntity<List<VilleDTO>> getAllVilles(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
