...
public class Site implements Serializable {
    ...
    public Site createdByUserLogin(String createdByUserLogin) {
    ...
    public Site updatedByUserLogin(String updatedByUserLogin) {
    ...
    public Site client(Client client) {
